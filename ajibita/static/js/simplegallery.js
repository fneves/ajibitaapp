...
var simpleGallery_navpanel={
	loadinggif: '/static/img/ajaxload.gif', //full path or URL to loading gif image
	panel: {height:'45px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Verdana'}, //customize nav panel container
	images: [ '/static/img/left.gif', '/static/img/play.gif', '/static/img/right.gif', '/static/img/pause.gif'], //nav panel images (in that order)
